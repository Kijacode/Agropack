...
class ShrineTheme extends InheritedWidget {
  ...
  final Color cardBackgroundColor = const Color(0xFF33691E);
  final Color appBarBackgroundColor = const Color(0xFF689F38);
  ...
  final TextStyle vendorItemStyle = robotoRegular12(const Color(0xFF010203));
