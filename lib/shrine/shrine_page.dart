...
class ShrinePageState extends State<ShrinePage> {
    ...
    showModalBottomSheet<void>(context: context, builder: (BuildContext context) {
      if (widget.shoppingCart.isEmpty) {
        return const Padding(
          ...
          child: Text('You haven`t selected any Projects')
        );
      }
      return ListView(
  ...
  void _emptyCart() {
    ...
    widget.scaffoldKey.currentState.showSnackBar(const SnackBar(content: Text('No projects selected')));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('AGROPACK', style: ShrineTheme.of(context).appBarTitleStyle),
        centerTitle: true,
        actions: <Widget>[
          IconButton(
            icon: const Icon(Icons.add),
            tooltip: 'Projects Interested',
          ...
          PopupMenuButton<ShrineAction>(
            itemBuilder: (BuildContext context) => <PopupMenuItem<ShrineAction>>[
              ...
              const PopupMenuItem<ShrineAction>(
                ...
                child: Text('Sort by types of project')
              ),
              const PopupMenuItem<ShrineAction>(
                value: ShrineAction.emptyCart,
                child: Text('Empty Interests')
              ),
              const PopupMenuItem<ShrineAction>(
                value: ShrineAction.consult,
                child: Text('Consult us on selected Projects')
              )
            ],
