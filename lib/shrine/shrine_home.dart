          ...
          SliverToBoxAdapter(
            ...
            children: <Widget>[
              Expanded(
                ...
                images: [
                  AssetImage('assets/maji.jpg'),
                  AssetImage('assets/1,pumpikin 2.jpg'),
                  AssetImage('assets/1,spinach.jpg'),
                  AssetImage('assets/2.Mushroom.jpg'),
                  AssetImage('assets/kabichi.jpg'),
                  AssetImage('assets/maji.jpg'),
                  AssetImage('assets/cassava.jpg'),
                  AssetImage('assets/ginger.JPG'),
                  AssetImage('assets/papaya.jpeg'),
                  AssetImage('assets/tomatoes.jpeg'),
                  AssetImage('assets/watermelon.jpeg'),
                  AssetImage('assets/9,agriculture equipment rental.JPG'),
                  AssetImage('assets/1,Pumpikin.jpg')
                ],
                animationCurve: Curves.fastOutSlowIn,
                animationDuration: Duration(milliseconds: 2000),
              )))
            ],
          )), // to create the slideshow at the top of the page
          SliverSafeArea(
            top: false,
